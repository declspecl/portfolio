    ...
    return (
        <main>
            <div>
                ...
                <p>
                    Let this be your fair warning to turn away while you still can... who knows what might be lurking in my unfiltered
                    thoughts 😱
                </p>
            </div>
            ...
            <section>
                ...
                <p className="mb-2">
                    My blog are where I talk about stuff I find interesting. Stop by here to think and potentially learn something!
                </p>
