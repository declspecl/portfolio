...
import { TechnologyBadge } from "@/components/common/technology-badges";
        ...
        <Dialog open={magnifiedScreenshot !== null}>
                            ...
                            <IconContext.Provider value={{ size: "1.25rem" }}>
                                {links?.github && (
                                    <Button size="icon-sm" variant="default" asChild>
                                        <a href={links.github} target="_blank" aria-label={`${project.name} GitHub link`} rel="noreferrer">
                                            <LuGithub />
                                        </a>
                                    </Button>
                                )}
                                {links?.live && (
                                    <Button size="icon-sm" asChild>
                                        <a href={links.live} target="_blank" aria-label={`${project.name} live site link`} rel="noreferrer">
                                            <LuGlobe />
                                        </a>
                                    </Button>
                                )}
            ...
            >
                {magnifiedScreenshot && (
                    <>
                        <DialogHeader>
                            <DialogTitle className="font-clash-display xs:text-3xl text-2xl font-semibold">
                                {magnifiedScreenshot.name}
                            </DialogTitle>
                        </DialogHeader>
